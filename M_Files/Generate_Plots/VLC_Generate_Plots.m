...
SRFR.XMinorGrid = 'on'
SRFR.YMinorGrid = 'on'
axis([SRRL],[0 5 -0.2 0.2])
grid(SRRL,'on')
SRRL.XMinorGrid = 'on'
SRRL.YMinorGrid = 'on'
axis([SRRR],[0 5 -0.2 0.2])
grid(SRRR,'on')
SRRR.XMinorGrid = 'on'
SRRR.YMinorGrid = 'on'
...
saveas(f1,'D:\SkyDrive\Thesis Paper and Other Works\Thesis LaTeX Rev1\Figures\Rev1\SMC_VLC_T_SA.jpg')

f2.PaperUnits = 'inches';
f2.PaperPosition = [0 0 6 3];
saveas(f2,'D:\SkyDrive\Thesis Paper and Other Works\Thesis LaTeX Rev1\Figures\Rev1\SMC_VLC_SR.jpg')

f3.PaperUnits = 'inches';
f3.PaperPosition = [0 0 6 3];
saveas(f3,'D:\SkyDrive\Thesis Paper and Other Works\Thesis LaTeX Rev1\Figures\Rev1\SMC_VLC_TQ.jpg')

f4.PaperUnits = 'inches';
f4.PaperPosition = [0 0 6 3];
saveas(f4,'D:\SkyDrive\Thesis Paper and Other Works\Thesis LaTeX Rev1\Figures\Rev1\SMC_VLC_VxVyr.jpg')

f5.PaperUnits = 'inches';
f5.PaperPosition = [0 0 6 3];
saveas(f5,'D:\SkyDrive\Thesis Paper and Other Works\Thesis LaTeX Rev1\Figures\Rev1\SMC_VLC_ERRs.jpg')