...
axis([TauFL TauFR TauRL TauRR],[0 8.5 -180 180])
grid(TauFL,'on')
TauFL.XMinorGrid = 'on'
TauFL.YMinorGrid = 'on'
grid(TauFR,'on')
...
saveas(f1,'D:\SkyDrive\Thesis Paper and Other Works\Thesis LaTeX Rev1\Figures\Rev1\SMC_Splitu_T_SA.jpg')

f2.PaperUnits = 'inches';
f2.PaperPosition = [0 0 6 3];
saveas(f2,'D:\SkyDrive\Thesis Paper and Other Works\Thesis LaTeX Rev1\Figures\Rev1\SMC_Splitu_SR.jpg')

f3.PaperUnits = 'inches';
f3.PaperPosition = [0 0 6 3];
saveas(f3,'D:\SkyDrive\Thesis Paper and Other Works\Thesis LaTeX Rev1\Figures\Rev1\SMC_Splitu_TQ.jpg')

f4.PaperUnits = 'inches';
f4.PaperPosition = [0 0 6 3];
saveas(f4,'D:\SkyDrive\Thesis Paper and Other Works\Thesis LaTeX Rev1\Figures\Rev1\SMC_Splitu_VxVyr.jpg')

f5.PaperUnits = 'inches';
f5.PaperPosition = [0 0 6 3];
saveas(f5,'D:\SkyDrive\Thesis Paper and Other Works\Thesis LaTeX Rev1\Figures\Rev1\SMC_Splitu_ERRs.jpg')