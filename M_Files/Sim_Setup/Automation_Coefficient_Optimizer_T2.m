    ...
    for cntr1=sim_pts_wa:-1:1
        for cntr2=1:sim_pts_yaw
            for cntr3=1:sim_pts_dyaw
                ...
                Wheel_Accel_Ctrl_Gain = cntr1*0.1
...
Filename_mat = sprintf('Fuzzy_Control_CSA_Test_175Nm_T2_%s.mat', datestr(now,'mm-dd-yyyy_HH-MM'));
save(Filename_mat);
...
Filename_fig = sprintf('Fuzzy_Control_CSA_Test_175Nm_T2_fig%s.fig', datestr(now,'mm-dd-yyyy_HH-MM'));
