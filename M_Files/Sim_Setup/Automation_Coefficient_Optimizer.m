...
Filename_mat = sprintf('Fuzzy_Control_VLC_3var_Test_%s.mat', datestr(now,'mm-dd-yyyy_HH-MM'));
save(Filename_mat);
...
Filename_fig = sprintf('Fuzzy_Control_VLC_3var_Test_fig_%s.fig', datestr(now,'mm-dd-yyyy_HH-MM'));
