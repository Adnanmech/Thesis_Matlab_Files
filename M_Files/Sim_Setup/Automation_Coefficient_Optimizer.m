...
Filename_c = sprintf('Fuzzy_Control_ABS_3var_wsat_Test_%s.mat', datestr(now,'mm-dd-yyyy_HH-MM'));
save(Filename_c);
...
Filename_fig = sprintf('Fuzzy_Control_ABS_3var_wsat_Test_fig_%s.fig', datestr(now,'mm-dd-yyyy_HH-MM'));
