...
Filename_mat = sprintf('Sliding_Mode_Control_VLC_Test_%s.mat', datestr(now,'mm-dd-yyyy_HH-MM'));
save(Filename_mat);
...
Filename_fig = sprintf('Sliding_Mode_Control_VLC_Test_fig_%s.fig', datestr(now,'mm-dd-yyyy_HH-MM'));
